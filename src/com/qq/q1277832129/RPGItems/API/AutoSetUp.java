...
/*Link start!*/
    ...
    public static void callInventory(Player p){
        ...
        addItemStack(ChatColor.BLUE+"鉴定武器",inv,p,"点击鉴定手中武器","鉴定石放最后一格");
        addItemStack(ChatColor.BOLD+"基础强化",inv,p,"点击强化手中武器","强化石放物品栏最后一格","保护石放物品栏倒数第二格");
        addItemStack(ChatColor.DARK_BLUE+"装备打孔",inv,p,"为手中装备打孔","打孔石放最后一格");
        addItemStack(ChatColor.GRAY+"宝石镶嵌",inv,p,"为手中装备镶嵌","镶嵌宝石放最后一格");
        addItemStack(ChatColor.DARK_RED+"装备洗炼",inv,p,"为手中物品洗炼","将洗炼石放最后一格","重新分配属性","有几率失败变成石头","保护石放倒数第二格可以避免报废");
        addItemStack(ChatColor.YELLOW+"装备维修",inv,p,"修复手中的物品","修复石放最后一格","消耗一个修复石");
    }
    public static void  gift(Player p){
        ...
        addItemStack(ChatColor.BOLD+"强化石",inv,p,"为你的武器进行强化");
        addItemStack(ChatColor.BOLD+"鉴定石",inv,p,"为你没有鉴定的武器进行鉴定");
        addItemStack(ChatColor.BOLD+"测试武器",inv,p,"未鉴定","打孔口","打孔口");
    }
