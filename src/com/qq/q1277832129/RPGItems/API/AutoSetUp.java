...
/*Link start!*/
    ...
    public static void callInventory(Player p){
        ...
        addItemStack("鉴定武器",inv,p,"点击鉴定手中武器");
        addItemStack("基础强化",inv,p,"点击强化手中武器","强化石放物品栏最后一格","保护石放物品栏倒数第二格");
        addItemStack("装备打孔",inv,p,"为手中装备打孔");
        addItemStack("宝石镶嵌",inv,p,"为手中装备镶嵌","宝石放最后一格");
        addItemStack("装备洗炼",inv,p,"为手中物品洗炼","有几率失败");
        addItemStack("装备维修",inv,p,"修复手中的物品");
    }
